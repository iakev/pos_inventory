...
class Migration(migrations.Migration):
    dependencies = [
        ...
        ("sales", "0016_alter_sales_business_id"),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "product",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="purchase_stock", to="products.stock"
                    ),
                ),
                (
                    "purchase",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="purchase_stock", to="sales.purchase"
                    ),
                ),
            ],
        ),
        migrations.AddField(
            model_name="purchase",
            name="products",
            field=models.ManyToManyField(related_name="sales", through="sales.PurchaseStock", to="products.stock"),
        ),
    ]
